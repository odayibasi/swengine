...
static swColor SWCOLOR_TENNQ_TAWNY={0.804f,0.341f,0.000f,1.000f};
...
DllExport void		swPointSet(swPoint *p,float x,float y);
...
DllExport void			swDimensionSet(swDimension *p,float w,float h);
...
DllExport void		swColorSet(swColor *color,float x,float y,float w,float h);
DllExport void		swColorCopy(swColor *copy,swColor *real);
DllExport swColor*	swColorClone(swColor *real);
...
DllExport void		swRectSet(swRect *rect,float x,float y,float w,float h);
DllExport void		swRectCopy(swRect *copy,swRect *real);
DllExport swRect*	swRectClone(swRect *real);
DllExport bool		swRectEquals(swRect *rect1,swRect *rect2);
